...
function station_name_25003(station_25005) {
	var F={procname:"fn1.stationName",prev:framePtr,filename:"fn1.nim",line:0};
	framePtr = F;
		F.line = 2;
		rawEcho(makeNimstrLit("Analyzing "), station_25005, makeNimstrLit(" station"));
	framePtr = F.prev;

	
}
station_name_25003(makeNimstrLit("Westergloor"));
station_name_25003(makeNimstrLit("Azaadville"));
station_name_25003(makeNimstrLit("Mohlakeng"));
